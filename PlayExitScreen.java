...
public class PlayExitScreen implements Screen {
    ...
    public PlayExitScreen(final MyGame game) {
        this.game = game;
        playButton = new Texture("playbutton1.png"); // Make sure this is in the assets folder
        exitButton = new Texture("exit (2).png"); // Make sure this is in the assets folder
        titleFont = new BitmapFont(); // Use default font
    }
    ...
    public void render(float delta) {
        ...
        // Draw the background (make sure you have this background in the game object)
