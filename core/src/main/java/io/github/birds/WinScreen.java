...
public class WinScreen implements Screen {
    ...
    public WinScreen(final MyGame game) {
        this.game = game;
        winBackground = new Texture("winscreen.png");
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.justTouched()) {
            ...
            if (x >= 10 && x <= 110 && y >= 10 && y <= 70) {
                game.setScreen(new io.github.birds.Screen.GameScreen(game, 1));  // Go back to GameScreen with level 1 (or whichever level)
