...
public class LoseScreen implements Screen {
    ...
    public LoseScreen(final MyGame game) {
        this.game = game;
        loseBackground = new Texture("loseScreen.png");
        backButton = new Texture("Back@4x.png");
    }
    ...
    public void render(float delta) {
        ...
        batch.begin();
        batch.draw(loseBackground, 0, 0, Gdx.graphics.getWidth(), Gdx.graphics.getHeight());
        ...
        if (Gdx.input.justTouched()) {
            ...
            if (x >= 10 && x <= 110 && y >= 10 && y <= 70) {
                ...
                System.out.println("Back button clicked on LoseScreen");
            }
        }
    }
